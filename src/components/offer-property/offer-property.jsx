...
const OfferProperty = (props) => {
  ...
  const {id, title, description, price, rating, bedrooms, guests, inside, type, isInBookmark, isPremium, host} = offer;
  const {avatar, name, isSuper} = host;
  const MAX_STAR_COUNT = 5;
  const ratingPercent = (Math.round(rating) / MAX_STAR_COUNT * 100) + `%`;
      ...
      <main className="page__main page__main--property">
        <section className="property">
            ...
            <div className="property__wrapper">
              ...
              <ul className="property__features">
                ...
                <li className="property__feature property__feature--adults">
                  Max {guests.adults} adults {guests.kids > 0 ? `& Max ${guests.kids} kids` : ``}
                </li>
              </ul>
          ...
          <section className="property__map map">
            <MapProperty currentOffer = {offer} offers = {offers} />
          </section>
        </section>
        <div className="container">
          <section className="near-places places">
            <h2 className="near-places__title">Other places in the neighbourhood</h2>
            <OfferListNear offers = {offers} onOfferTitleClick = {onOfferTitleClick} />
          </section>
        </div>
      </main>
    </div>
