...
const Main = (props) => {
  const {offersFound, offers, cities, onOfferTitleClick, onCityTitleClick, selectedCity} = props;
            ...
            offers.length === 0 ? <MainEmpty /> :
              <div className="cities__places-container container">
                <section className="cities__places places">
                  ...
                  <b className="places__found">{offersFound} place{offersFound > 1 ? `s` : ``} to stay in {selectedCity}</b>
                  ...
                  <OfferListMain offers = {offers} onOfferTitleClick = {onOfferTitleClick} />
                </section>
